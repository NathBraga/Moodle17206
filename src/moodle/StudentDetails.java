...
public class StudentDetails extends javax.swing.JFrame {
    ...
    //making connection with database
     ...
     //making a list to create a class to bring the Student details
     public ArrayList<User> selectStudentDetail(){
      
      ArrayList<User> studentDetail = new ArrayList<User>();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Student ID", "Name", "Surname", "Phone", "Branch", "Course"
            }
        ));
