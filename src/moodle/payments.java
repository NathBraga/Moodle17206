...
public class payments extends javax.swing.JFrame {
    ...
    payments(String studentID, String courseName, double fees, double paymentAmount, String date){
    ...
    //create a method
    double calculatePaymentFees(){
        
        double balanceValue;
        balanceValue = fees - paymentAmount;
        return balanceValue;
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Financial Controller");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Student ID", "Course", "Fees", "Payment Amount", "Date", "Balance Due"
            }
        ));
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Accountancy", "Business", "English", "IT" }));
